...
class AlexaResponse:
    ...
    def create_payload_endpoint_capability(self, **kwargs):
        ...
        supported_operations = kwargs.get('supportedOperations', None)
        
        if supported or supported_operations:
            capability['properties'] = {}
            
            if supported:
                capability['properties']['supported'] = supported
            elif supported_operations:
                capability['properties']['supportedOperations'] = supported_operations
